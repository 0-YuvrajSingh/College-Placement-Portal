      ...
      RegisterRequest: {
        ...
        properties: {
          ...
          department: {
            ...
            description: "Optional — student branch",
          },
          cgpa: { type: "number", minimum: 0, maximum: 10, description: "Optional — student CGPA" },
          rollNumber: { type: "string", description: "Optional — student roll number" },
          companyName: { type: "string", description: "Optional — recruiter company name" },
        },
      },
      LoginRequest: {
        type: "object",
